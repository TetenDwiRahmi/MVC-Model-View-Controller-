...
class Barang_model {
    ...
    {
       $this->db->query('SELECT barang.*, jenis.nama_jenis, jenis.id as id_jenis,supplier.id as id_supplier, supplier.nama_supplier FROM ' . $this->table .
       ' INNER JOIN jenis ON barang.id_jenis = jenis.id 
